...
const Navigation = ({ activeTab, setActiveTab, isOpen, toggleSidebar }) => {
  const [expandedGroups, setExpandedGroups] = useState(['project', 'summary']);
  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        // { id: 'topic_results', label: '토픽 클러스터 맵', icon: <Map size={16} /> },
    ...
    },
    {
      ...
      icon: <LayoutDashboard size={20} />,
      items: [
        { id: 'church_summary', label: '교회별 결과 모아보기', icon: <Map size={16} /> },
      ]
    },
  ];
    ...
    <aside className={`sidebar ${!isOpen ? 'collapsed' : ''}`}>
      <div className="sidebar-header">
        <div className="logo-container">
          <img src="/hail.png" alt="HAIL Lab Logo" className="sidebar-logo-img" />
