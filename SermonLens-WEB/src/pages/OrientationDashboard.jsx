        ...
        <div className="page-header-main">
          ...
          <div className="header-controls">
            <div className="control-group">
              ...
              <div className="select-wrapper">
                ...
                >
                  ...
                  <option value="compare">⚖️ 채널 비교 분석</option>
            ...
            <div className={`control-group ${!(currentView === 'compare' || currentView === 'scatter') ? 'disabled' : ''}`}>
              <label className="control-label">대상 채널</label>
          ...
          >
            ...
            <div className="overall-summary-bar">
              <div className="summary-header">
                ...
                <h3 className="summary-title">채널 구독자 순 상위 {processedData.length}개 교회 평균</h3>
              </div>
            ...
            <div className="scale-guide-footer">
              <div className="scale-guide-info">
                ...
                <span className="scale-guide-desc">모든 차트는 분석 데이터 내 상대적 비교를 위해 각 지표별 각 채널의 평균 점수의 최댓값을 만점으로 하여 자동 스케일링됩니다.</span>
              </div>
