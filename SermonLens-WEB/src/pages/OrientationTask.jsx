        ...
        <div className="intro-grid">
          <motion.div className="intro-card" variants={itemVariants}>
            ...
            <p style={{ fontSize: '1.2rem', lineHeight: '1.7' }}>
              방대한 분량의 설교 문맥을 정확하게 파악하기 위해, 대용량 컨텍스트 처리와 고도의 추론 능력이 뛰어난 <span style={{ fontFamily: 'Consolas, monospace', fontWeight: 'bold', color: 'var(--color-brand-primary)' }}>gemma-4-26b-a4b-it</span> 모델을 채택했습니다. 최대 90개 스레드의 병렬 환경을 구축하여 대규모 추론 작업을 빠르고 안정적으로 수행합니다.
            </p>
          </motion.div>
          ...
          <div className="criteria-container">
            <div className="criteria-column">
              ...
              <p style={{ fontSize: '1.1rem', color: 'var(--color-text-secondary)', lineHeight: '1.7' }}>
                설교의 각 섹션(전/후반)에 대해 3번의 독립 평가를 수행합니다. 그중 <strong>2번 이상의 결과가 일치</strong>할 때만 해당 섹션의 판정 결과로 인정하여 데이터의 신뢰도를 확보합니다.
              </p>
            </div>
            ...
            <div className="criteria-column">
              ...
              <p style={{ fontSize: '1.1rem', color: 'var(--color-text-secondary)', lineHeight: '1.7' }}>
                전반부 혹은 후반부 중 어느 한 곳에서라도 지향성이 탐지되면 이를 결과에 반영합니다. 이는 설교 내에 조금이라도 나타난 경향성을 놓치지 않기 위함입니다.
              </p>
            </div>
