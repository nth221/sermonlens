          ...
          <motion.div className="dev-card-outer" variants={itemVariants}>
            <div className="dev-card">
              <div className="lab-info">
                <img src="/hail.png" alt="HAIL Lab" className="lab-logo-giant" />
                <img src="/AIEC.png" alt="AIEC Lab" className="lab-logo-giant" />
              </div>
        ...
        <motion.div className="intro-criteria-section" variants={itemVariants}>
          ...
          <div className="criteria-container">
            ...
            <div className="criteria-column">
              ...
              <div className="tech-tag">모델: gemini-3.1-flash-lite-preview</div>
              <ul>
