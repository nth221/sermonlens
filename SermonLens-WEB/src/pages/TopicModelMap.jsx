...
import topicData from '../data/topicmodel/global_topic_merged_map.json';
...
const TopicModelMap = () => {
  ...
  const topics = useMemo(() => buildTopicPoints(), []);
    ...
    <div className="guide-wrapper full-height-wrapper topic-map-3d-page">
      <div className="page-header compact">
        <div className="page-header-main">
          <div className="title-area">
            <h2 className="page-title">3D 토픽 지형도 테스트</h2>
          </div>
      ...
      >
        ...
        <div className="topic-map-3d-canvas">
          ...
          <TopicDetailPanel topic={selectedTopicInfo} />
        </div>
      </div>
