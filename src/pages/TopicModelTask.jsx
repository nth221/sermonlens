              ...
              <div className="topic-representation-grid">
                <div>
                  <p style={{ fontSize: '1.1rem', color: 'var(--color-text-secondary)', lineHeight: '1.7', marginTop: 0 }}>
                    토픽 지형도의 각 <strong>클러스터</strong>는 단순한 색상 구역이 아니라 하나의 <strong>topic representation</strong>입니다.
                    같은 클러스터에 속한 설교들은 의미적으로 가까운 문서 집합이며, 이 집합을 해석 가능한 토픽으로 만들기 위해 대표 문서와 c-TF-IDF 키워드를 함께 사용합니다.
                  </p>

                  <p style={{ fontSize: '1.1rem', color: 'var(--color-text-secondary)', lineHeight: '1.7', marginTop: '1rem' }}>
                    c-TF-IDF는 각 클러스터 내에서 특정 단어가 해당 토픽을 얼마나 대표하는지 계산하여 <strong>핵심 키워드의 가중치</strong>를 산출합니다.
                  </p>
                ...
                <div className="topic-representation-actions">
                  <div className="topic-representation-note topic-representation-note-blue">
                    ...
                    <p>
                      각 클러스터의 중심점에 가까운 대표 설교문과 해당 클러스터의 c-TF-IDF 상위 키워드를 LLM에 함께 제공합니다.
                  ...
                  <div className="topic-representation-note topic-representation-note-green">
                    ...
                    <p>
                      ...
                      가중치가 높은 키워드일수록 더 크게 표시되어, 클러스터를 대표하는 핵심 어휘를 빠르게 파악할 수 있습니다.
                    </p>
                  </div>
                </div>
              </div>
